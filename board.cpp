...
Board::Board(Window * w,int x, int y, int sx, int sy, int row, int col, std::function<string(int x, int y, int sx, int sy, int borderSize)> f)
    : Widget(w,x,y,sx,sy), _row(row), _col(col), _f(f)
{
    int gap = 1;
